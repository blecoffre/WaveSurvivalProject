...
namespace NeoFPS
{
	public struct PhysicsFilter
	{
		...
		public static class Masks
		{
            ...
            public static readonly PhysicsFilter Interactable = new PhysicsFilter(LayerFilter.Default | LayerFilter.InteractiveObjects | LayerFilter.EnvironmentRough | LayerFilter.CharacterPhysics);
